...
class InsertDogsActivity : AppCompatActivity() {
    ...
    private fun validarCampos(): Boolean {
        return !(binding!!.edtxtEdad.text.toString()
            .isEmpty() && binding!!.edtxtNombre.text.toString()
            .isEmpty() && binding!!.edtxtRaza.text.toString()
            .isEmpty() && binding!!.edtxtNChip.text.toString()
            .isEmpty() && binding!!.edtxtPeso.text.toString().isEmpty())
    }
